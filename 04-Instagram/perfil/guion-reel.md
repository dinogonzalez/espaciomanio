# Guión de reel corto – Espacio Mañio

## Duración: 15–20 segundos
## Escenas (sin música comercial):
1. 0–3 s: Llegada. Auto estacionando frente a la parcela.
2. 3–7 s: Recorrido rápido: pasillo → piscina.
3. 7–11 s: Quincho con parrilla encendida.
4. 11–15 s: Áreas verdes con personas o mesas listas.
5. 15–18 s: Zoom a piscina con tarjeta final de texto.
